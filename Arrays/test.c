...
char *pvoid=NULL;
arraysSetValue(&a,"null",NULL,0,AARRAY_DONT_DUPLICATE);
arraysSetValue(&a,"void",&pvoid,sizeof(char *),AARRAY_DONT_DUPLICATE);
arraysDisplayArray(stdout,a);
AssocArray *b=arraysCopyArray(a,1);
arraysFreeArray(a);
arraysDisplayArray(stdout,b);
arraysFreeArray(b);
exit(0);
}
